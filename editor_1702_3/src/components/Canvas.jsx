...
const Canvas = ({handleFinalTemplateUpdate,templateIndex,setCurrentOpenTemplate,printer}) => {
  ...
  const [reportTemplate, setReportTemplate] = useState({
    templateId: templateIndex+1, schema: {
      additionalInfo: {
        dataFields: [], Header: [
          // {
  ...
  useEffect(()=>{
    handleFinalTemplateUpdate(templateIndex,reportTemplate);
    setCurrentOpenTemplate({
      selected: trackselected,
      setCanvasItems: setCanvasItems,
      updateTemplateTextField: updateTemplateTextField,
      canvasItems: canvasItems
    })
  },[canvasItems,trackselected]);

  return (
    <div
      id="print-canvas"
      className=" print-canvas mb-3 shadow-md overflow-y-auto overflow-x-clip bg-white"
    >
